      ...
      <View style={styles.containerHeader}>
        <View style={styles.containerHeaderTop}>
          ...
          <View style={styles.containerHeaderTop_Right}>
            <Text style ={{fontSize:18,fontWeight:'bold',marginBottom:10,}}>Nguyên hàm tích phân và ứng dụng</Text>
            <Text style ={{fontSize:16,fontWeight:'bold',marginBottom:10,}}>Cung cấp bởi Tiki Trading</Text>
            <Text style ={{fontSize:20,fontWeight:'bold',marginBottom:10,color:'red'}}>{total} đ</Text>
            ...
            <View style ={styles.containerHeaderTop_Right_Row1}>
              <View style ={styles.containerHeaderTop_Right_Button}>
                  ...
                  <Text style={{marginRight:12,textAlign:'center',}}> {count} </Text>
                  <TouchableOpacity onPress={handlecountAdd} style={styles.button}>
                      <Text>+</Text>
                  </TouchableOpacity>
              </View>
        ...
        <View style={styles.containerButtom}>
          <View style={styles.containerButtom_Top}>
            ...
            <Text style ={{fontSize:22,fontWeight:'bold',marginBottom:10,color:'red'}}>{total} đ</Text>
          </View>
